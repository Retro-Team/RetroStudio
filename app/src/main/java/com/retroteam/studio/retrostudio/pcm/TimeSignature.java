...
/*
 *	I don't quite know how to use this yet.
 */
...
public class TimeSignature implements Serializable
{
	...
	public TimeSignature(int beats, int notes)
	{
		this.beats = Math.abs(beats);
		this.notes = Math.abs(notes);
	}
	public int beats() { return beats; }
	public int notes() { return notes; }
}
